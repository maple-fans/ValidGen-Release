	...
	public static List<HashMap<String, Object>> getJsonList(String json) {
	    	List<HashMap<String, Object>> dataList;
	    	   ...
	    	   try {
	            ...
	            JSONArray dataArray = rootObject.getJSONArray("Payment");

	            for (int i = 0; i < dataArray.length(); i++) {
	
	   JSONObject sonObject = dataArray.getJSONObject(i);
	   
	   String AmountTenderedStr = String.valueOf(sonObject.get("AmountTendered"));

			                
			        HashMap<String, Object> map = new HashMap<>(); 
					map.put("AmountTendered", AmountTenderedStr);
