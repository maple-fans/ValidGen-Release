	...
	*/ 
	...
	public void generatOperationPane() {
		 ...
		 operationPanels.put("deleteSupplier", deleteSupplier);
			...
			Button openStore_Store_input_State=new Button();
			openStore_Store_input_State.setText("LoadFromState");
			openStore_content.add(openStore_Store_input_State);
			 openStore_Store_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(openStore_Store_input_State,2,0);
			
			Button openStore_Store_input_reset_t=new Button();
			openStore_Store_input_reset_t.setText("InputReset");
			openStore_content.add(openStore_Store_input_reset_t);
			 openStore_Store_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(openStore_Store_input_reset_t,2,1); 
			
			Button openStore_Store_select_Input=new Button();
									openStore_Store_select_Input.setText("SelectInput");
									openStore_content.add(openStore_Store_select_Input);
									 openStore_Store_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(openStore_Store_select_Input,2,2);
			

		openStore_Store_input_State.setOnMouseClicked((e) -> {
			List<Store> rs = EntityManager.getAllInstancesOf("Store") ;
			int index=(int)(Math.random() * rs.size());

				openStore_storeID_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					openStore_Store_input_reset_t.setOnMouseClicked((e) -> {
				openStore_storeID_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			openStore_storeID_t.setOnMouseClicked((e) -> {

			TableView obs = allObjectTables.get("Store");
...
openStore_storeID_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		openStore_Store_select_Input.setOnMouseClicked((e) -> {
...
openStore_storeID_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button closeStore_Store_input_State=new Button();
			closeStore_Store_input_State.setText("LoadFromState");
			closeStore_content.add(closeStore_Store_input_State);
			 closeStore_Store_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(closeStore_Store_input_State,2,0);
			
			Button closeStore_Store_input_reset_t=new Button();
			closeStore_Store_input_reset_t.setText("InputReset");
			closeStore_content.add(closeStore_Store_input_reset_t);
			 closeStore_Store_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(closeStore_Store_input_reset_t,2,1); 
			
			Button closeStore_Store_select_Input=new Button();
									closeStore_Store_select_Input.setText("SelectInput");
									closeStore_content.add(closeStore_Store_select_Input);
									 closeStore_Store_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(closeStore_Store_select_Input,2,2);
			

		closeStore_Store_input_State.setOnMouseClicked((e) -> {
			List<Store> rs = EntityManager.getAllInstancesOf("Store") ;
			int index=(int)(Math.random() * rs.size());

				closeStore_storeID_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					closeStore_Store_input_reset_t.setOnMouseClicked((e) -> {
				closeStore_storeID_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			closeStore_storeID_t.setOnMouseClicked((e) -> {
...
closeStore_storeID_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		closeStore_Store_select_Input.setOnMouseClicked((e) -> {
...
closeStore_storeID_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button openCashDesk_CashDesk_input_State=new Button();
			openCashDesk_CashDesk_input_State.setText("LoadFromState");
			openCashDesk_content.add(openCashDesk_CashDesk_input_State);
			 openCashDesk_CashDesk_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(openCashDesk_CashDesk_input_State,2,0);
			
			Button openCashDesk_CashDesk_input_reset_t=new Button();
			openCashDesk_CashDesk_input_reset_t.setText("InputReset");
			openCashDesk_content.add(openCashDesk_CashDesk_input_reset_t);
			 openCashDesk_CashDesk_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(openCashDesk_CashDesk_input_reset_t,2,1); 
			
			Button openCashDesk_CashDesk_select_Input=new Button();
									openCashDesk_CashDesk_select_Input.setText("SelectInput");
									openCashDesk_content.add(openCashDesk_CashDesk_select_Input);
									 openCashDesk_CashDesk_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(openCashDesk_CashDesk_select_Input,2,2);
			

		openCashDesk_CashDesk_input_State.setOnMouseClicked((e) -> {
			List<CashDesk> rs = EntityManager.getAllInstancesOf("CashDesk") ;
			int index=(int)(Math.random() * rs.size());

				openCashDesk_cashDeskID_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					openCashDesk_CashDesk_input_reset_t.setOnMouseClicked((e) -> {
				openCashDesk_cashDeskID_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			openCashDesk_cashDeskID_t.setOnMouseClicked((e) -> {

			TableView obs = allObjectTables.get("CashDesk");
...
openCashDesk_cashDeskID_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		openCashDesk_CashDesk_select_Input.setOnMouseClicked((e) -> {
...
openCashDesk_cashDeskID_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button closeCashDesk_CashDesk_input_State=new Button();
			closeCashDesk_CashDesk_input_State.setText("LoadFromState");
			closeCashDesk_content.add(closeCashDesk_CashDesk_input_State);
			 closeCashDesk_CashDesk_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(closeCashDesk_CashDesk_input_State,2,0);
			
			Button closeCashDesk_CashDesk_input_reset_t=new Button();
			closeCashDesk_CashDesk_input_reset_t.setText("InputReset");
			closeCashDesk_content.add(closeCashDesk_CashDesk_input_reset_t);
			 closeCashDesk_CashDesk_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(closeCashDesk_CashDesk_input_reset_t,2,1); 
			
			Button closeCashDesk_CashDesk_select_Input=new Button();
									closeCashDesk_CashDesk_select_Input.setText("SelectInput");
									closeCashDesk_content.add(closeCashDesk_CashDesk_select_Input);
									 closeCashDesk_CashDesk_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(closeCashDesk_CashDesk_select_Input,2,2);
			

		closeCashDesk_CashDesk_input_State.setOnMouseClicked((e) -> {
			List<CashDesk> rs = EntityManager.getAllInstancesOf("CashDesk") ;
			int index=(int)(Math.random() * rs.size());

				closeCashDesk_cashDeskID_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					closeCashDesk_CashDesk_input_reset_t.setOnMouseClicked((e) -> {
				closeCashDesk_cashDeskID_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			closeCashDesk_cashDeskID_t.setOnMouseClicked((e) -> {
...
closeCashDesk_cashDeskID_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		closeCashDesk_CashDesk_select_Input.setOnMouseClicked((e) -> {
...
closeCashDesk_cashDeskID_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button enterItem_Item_input_State=new Button();
			enterItem_Item_input_State.setText("LoadFromState");
			enterItem_content.add(enterItem_Item_input_State);
			 enterItem_Item_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(enterItem_Item_input_State,2,0);
			
			Button enterItem_Item_input_reset_t=new Button();
			enterItem_Item_input_reset_t.setText("InputReset");
			enterItem_content.add(enterItem_Item_input_reset_t);
			 enterItem_Item_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(enterItem_Item_input_reset_t,2,1); 
			
			Button enterItem_Item_select_Input=new Button();
									enterItem_Item_select_Input.setText("SelectInput");
									enterItem_content.add(enterItem_Item_select_Input);
									 enterItem_Item_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(enterItem_Item_select_Input,2,2);
			

		enterItem_Item_input_State.setOnMouseClicked((e) -> {
			List<Item> rs = EntityManager.getAllInstancesOf("Item") ;
			int index=(int)(Math.random() * rs.size());

				enterItem_barcode_t.setText(String.valueOf(rs.get(index).getBarcode()));
			...
			//reset input button click
	 					enterItem_Item_input_reset_t.setOnMouseClicked((e) -> {
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			enterItem_barcode_t.setOnMouseClicked((e) -> {

			TableView obs = allObjectTables.get("Item");
...
enterItem_barcode_t.setText(String.valueOf(rs.get(objectindex).getBarcode()));
...
enterItem_quantity_t.setText(String.valueOf(indexStockNumber));
		...
		enterItem_Item_select_Input.setOnMouseClicked((e) -> {
...
enterItem_quantity_t.setText(String.valueOf(indexStockNumber));
			...
			Button orderItem_Item_input_State=new Button();
			orderItem_Item_input_State.setText("LoadFromState");
			orderItem_content.add(orderItem_Item_input_State);
			 orderItem_Item_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(orderItem_Item_input_State,2,0);
			
			Button orderItem_Item_input_reset_t=new Button();
			orderItem_Item_input_reset_t.setText("InputReset");
			orderItem_content.add(orderItem_Item_input_reset_t);
			 orderItem_Item_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(orderItem_Item_input_reset_t,2,1); 
			
			Button orderItem_Item_select_Input=new Button();
									orderItem_Item_select_Input.setText("SelectInput");
									orderItem_content.add(orderItem_Item_select_Input);
									 orderItem_Item_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(orderItem_Item_select_Input,2,2);
			

		orderItem_Item_input_State.setOnMouseClicked((e) -> {
			List<Item> rs = EntityManager.getAllInstancesOf("Item") ;
			int index=(int)(Math.random() * rs.size());

				orderItem_barcode_t.setText(String.valueOf(rs.get(index).getBarcode()));
					

				int indexStockNumber=(int)(Math.random()*rs.get(index).getStockNumber());
				orderItem_quantity_t.setText(String.valueOf(indexStockNumber));
			...
			//reset input button click
	 					orderItem_Item_input_reset_t.setOnMouseClicked((e) -> {
				orderItem_barcode_t.setText("");
				enterItem_quantity_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			orderItem_barcode_t.setOnMouseClicked((e) -> {
...
orderItem_barcode_t.setText(String.valueOf(rs.get(objectindex).getBarcode()));
...
orderItem_quantity_t.setText(String.valueOf(indexStockNumber));
		...
		orderItem_Item_select_Input.setOnMouseClicked((e) -> {
...
orderItem_quantity_t.setText(String.valueOf(indexStockNumber));
			...
			Button chooseSupplier_Supplier_input_State=new Button();
			chooseSupplier_Supplier_input_State.setText("LoadFromState");
			chooseSupplier_content.add(chooseSupplier_Supplier_input_State);
			 chooseSupplier_Supplier_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(chooseSupplier_Supplier_input_State,2,0);
			
			Button chooseSupplier_Supplier_input_reset_t=new Button();
			chooseSupplier_Supplier_input_reset_t.setText("InputReset");
			chooseSupplier_content.add(chooseSupplier_Supplier_input_reset_t);
			 chooseSupplier_Supplier_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(chooseSupplier_Supplier_input_reset_t,2,1); 
			
			Button chooseSupplier_Supplier_select_Input=new Button();
									chooseSupplier_Supplier_select_Input.setText("SelectInput");
									chooseSupplier_content.add(chooseSupplier_Supplier_select_Input);
									 chooseSupplier_Supplier_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(chooseSupplier_Supplier_select_Input,2,2);
			

		chooseSupplier_Supplier_input_State.setOnMouseClicked((e) -> {
			List<Supplier> rs = EntityManager.getAllInstancesOf("Supplier") ;
			int index=(int)(Math.random() * rs.size());

				chooseSupplier_supplierID_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					chooseSupplier_Supplier_input_reset_t.setOnMouseClicked((e) -> {
				chooseSupplier_supplierID_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			chooseSupplier_supplierID_t.setOnMouseClicked((e) -> {

			TableView obs = allObjectTables.get("Supplier");
...
chooseSupplier_supplierID_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		chooseSupplier_Supplier_select_Input.setOnMouseClicked((e) -> {
...
chooseSupplier_supplierID_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button changePrice_Item_input_State=new Button();
			changePrice_Item_input_State.setText("LoadFromState");
			changePrice_content.add(changePrice_Item_input_State);
			 changePrice_Item_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(changePrice_Item_input_State,2,0);
			
			Button changePrice_Item_input_reset_t=new Button();
			changePrice_Item_input_reset_t.setText("InputReset");
			changePrice_content.add(changePrice_Item_input_reset_t);
			 changePrice_Item_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(changePrice_Item_input_reset_t,2,1); 
			
			Button changePrice_Item_select_Input=new Button();
									changePrice_Item_select_Input.setText("SelectInput");
									changePrice_content.add(changePrice_Item_select_Input);
									 changePrice_Item_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(changePrice_Item_select_Input,2,2);
			

		changePrice_Item_input_State.setOnMouseClicked((e) -> {
			List<Item> rs = EntityManager.getAllInstancesOf("Item") ;
			int index=(int)(Math.random() * rs.size());

				changePrice_barcode_t.setText(String.valueOf(rs.get(index).getBarcode()));
			...
			//reset input button click
	 					changePrice_Item_input_reset_t.setOnMouseClicked((e) -> {
				changePrice_barcode_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			changePrice_barcode_t.setOnMouseClicked((e) -> {
...
changePrice_barcode_t.setText(String.valueOf(rs.get(objectindex).getBarcode()));
		...
		changePrice_Item_select_Input.setOnMouseClicked((e) -> {
...
changePrice_barcode_t.setText(String.valueOf(rs.get(objectindex).getBarcode()));
			...
			Button receiveOrderedProduct_OrderProduct_input_State=new Button();
			receiveOrderedProduct_OrderProduct_input_State.setText("LoadFromState");
			receiveOrderedProduct_content.add(receiveOrderedProduct_OrderProduct_input_State);
			 receiveOrderedProduct_OrderProduct_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(receiveOrderedProduct_OrderProduct_input_State,2,0);
			
			Button receiveOrderedProduct_OrderProduct_input_reset_t=new Button();
			receiveOrderedProduct_OrderProduct_input_reset_t.setText("InputReset");
			receiveOrderedProduct_content.add(receiveOrderedProduct_OrderProduct_input_reset_t);
			 receiveOrderedProduct_OrderProduct_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(receiveOrderedProduct_OrderProduct_input_reset_t,2,1); 
			
			Button receiveOrderedProduct_OrderProduct_select_Input=new Button();
									receiveOrderedProduct_OrderProduct_select_Input.setText("SelectInput");
									receiveOrderedProduct_content.add(receiveOrderedProduct_OrderProduct_select_Input);
									 receiveOrderedProduct_OrderProduct_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(receiveOrderedProduct_OrderProduct_select_Input,2,2);
			

		receiveOrderedProduct_OrderProduct_input_State.setOnMouseClicked((e) -> {
			List<OrderProduct> rs = EntityManager.getAllInstancesOf("OrderProduct") ;
			int index=(int)(Math.random() * rs.size());

				receiveOrderedProduct_orderID_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					receiveOrderedProduct_OrderProduct_input_reset_t.setOnMouseClicked((e) -> {
				receiveOrderedProduct_orderID_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			receiveOrderedProduct_orderID_t.setOnMouseClicked((e) -> {

			TableView obs = allObjectTables.get("OrderProduct");
...
receiveOrderedProduct_orderID_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		receiveOrderedProduct_OrderProduct_select_Input.setOnMouseClicked((e) -> {
...
receiveOrderedProduct_orderID_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button createStore_Store_input_State=new Button();
			createStore_Store_input_State.setText("LoadFromState");
			createStore_content.add(createStore_Store_input_State);
			 createStore_Store_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createStore_Store_input_State,2,0);
			
			Button createStore_Store_input_reset_t=new Button();
			createStore_Store_input_reset_t.setText("InputReset");
			createStore_content.add(createStore_Store_input_reset_t);
			 createStore_Store_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createStore_Store_input_reset_t,2,1); 
			
			Button createStore_Store_select_Input=new Button();
									createStore_Store_select_Input.setText("SelectInput");
									createStore_content.add(createStore_Store_select_Input);
									 createStore_Store_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(createStore_Store_select_Input,2,2);
			

		createStore_Store_input_State.setOnMouseClicked((e) -> {
			List<Store> rs = EntityManager.getAllInstancesOf("Store") ;
			int index=(int)(Math.random() * rs.size());

				createStore_id_t.setText(String.valueOf(rs.get(index).getId()));
					

				createStore_name_t.setText(String.valueOf(rs.get(index).getName()));
					

				createStore_address_t.setText(String.valueOf(rs.get(index).getAddress()));
					

				createStore_isopened_t.setText(String.valueOf(rs.get(index).getIsOpened()));
			...
			//reset input button click
	 					createStore_Store_input_reset_t.setOnMouseClicked((e) -> {
				createStore_id_t.setText("");
				createStore_name_t.setText("");
				createStore_address_t.setText("");
				createStore_isopened_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			createStore_id_t.setOnMouseClicked((e) -> {
...
createStore_id_t.setText(String.valueOf(rs.get(objectindex).getId()));

		 				 			 			
createStore_name_t.setText(String.valueOf(rs.get(objectindex).getName()));

		 				 			 			
createStore_address_t.setText(String.valueOf(rs.get(objectindex).getAddress()));

		 				 			 			
createStore_isopened_t.setText(String.valueOf(rs.get(objectindex).getIsOpened()));
		...
		createStore_Store_select_Input.setOnMouseClicked((e) -> {
...
createStore_isopened_t.setText(String.valueOf(rs.get(objectindex).getIsOpened()));
			...
			Button queryStore_Store_input_State=new Button();
			queryStore_Store_input_State.setText("LoadFromState");
			queryStore_content.add(queryStore_Store_input_State);
			 queryStore_Store_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(queryStore_Store_input_State,2,0);
			
			Button queryStore_Store_input_reset_t=new Button();
			queryStore_Store_input_reset_t.setText("InputReset");
			queryStore_content.add(queryStore_Store_input_reset_t);
			 queryStore_Store_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(queryStore_Store_input_reset_t,2,1); 
			
			Button queryStore_Store_select_Input=new Button();
									queryStore_Store_select_Input.setText("SelectInput");
									queryStore_content.add(queryStore_Store_select_Input);
									 queryStore_Store_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(queryStore_Store_select_Input,2,2);
			

		queryStore_Store_input_State.setOnMouseClicked((e) -> {
			List<Store> rs = EntityManager.getAllInstancesOf("Store") ;
			int index=(int)(Math.random() * rs.size());

				queryStore_id_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					queryStore_Store_input_reset_t.setOnMouseClicked((e) -> {
				queryStore_id_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			queryStore_id_t.setOnMouseClicked((e) -> {
...
queryStore_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		queryStore_Store_select_Input.setOnMouseClicked((e) -> {
...
queryStore_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button modifyStore_Store_input_State=new Button();
			modifyStore_Store_input_State.setText("LoadFromState");
			modifyStore_content.add(modifyStore_Store_input_State);
			 modifyStore_Store_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifyStore_Store_input_State,2,0);
			
			Button modifyStore_Store_input_reset_t=new Button();
			modifyStore_Store_input_reset_t.setText("InputReset");
			modifyStore_content.add(modifyStore_Store_input_reset_t);
			 modifyStore_Store_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifyStore_Store_input_reset_t,2,1); 
			
			Button modifyStore_Store_select_Input=new Button();
									modifyStore_Store_select_Input.setText("SelectInput");
									modifyStore_content.add(modifyStore_Store_select_Input);
									 modifyStore_Store_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(modifyStore_Store_select_Input,2,2);
			

		modifyStore_Store_input_State.setOnMouseClicked((e) -> {
			List<Store> rs = EntityManager.getAllInstancesOf("Store") ;
			int index=(int)(Math.random() * rs.size());

				modifyStore_id_t.setText(String.valueOf(rs.get(index).getId()));
					

				modifyStore_name_t.setText(String.valueOf(rs.get(index).getName()));
					

				modifyStore_address_t.setText(String.valueOf(rs.get(index).getAddress()));
					

				modifyStore_isopened_t.setText(String.valueOf(rs.get(index).getIsOpened()));
			...
			//reset input button click
	 					modifyStore_Store_input_reset_t.setOnMouseClicked((e) -> {
				modifyStore_id_t.setText("");
				modifyStore_name_t.setText("");
				modifyStore_address_t.setText("");
				modifyStore_isopened_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			modifyStore_id_t.setOnMouseClicked((e) -> {
...
modifyStore_id_t.setText(String.valueOf(rs.get(objectindex).getId()));

		 				 			 			
modifyStore_name_t.setText(String.valueOf(rs.get(objectindex).getName()));

		 				 			 			
modifyStore_address_t.setText(String.valueOf(rs.get(objectindex).getAddress()));

		 				 			 			
modifyStore_isopened_t.setText(String.valueOf(rs.get(objectindex).getIsOpened()));
		...
		modifyStore_Store_select_Input.setOnMouseClicked((e) -> {
...
modifyStore_isopened_t.setText(String.valueOf(rs.get(objectindex).getIsOpened()));
			...
			Button deleteStore_Store_input_State=new Button();
			deleteStore_Store_input_State.setText("LoadFromState");
			deleteStore_content.add(deleteStore_Store_input_State);
			 deleteStore_Store_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteStore_Store_input_State,2,0);
			
			Button deleteStore_Store_input_reset_t=new Button();
			deleteStore_Store_input_reset_t.setText("InputReset");
			deleteStore_content.add(deleteStore_Store_input_reset_t);
			 deleteStore_Store_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteStore_Store_input_reset_t,2,1); 
			
			Button deleteStore_Store_select_Input=new Button();
									deleteStore_Store_select_Input.setText("SelectInput");
									deleteStore_content.add(deleteStore_Store_select_Input);
									 deleteStore_Store_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(deleteStore_Store_select_Input,2,2);
			

		deleteStore_Store_input_State.setOnMouseClicked((e) -> {
			List<Store> rs = EntityManager.getAllInstancesOf("Store") ;
			int index=(int)(Math.random() * rs.size());

				deleteStore_id_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					deleteStore_Store_input_reset_t.setOnMouseClicked((e) -> {
				deleteStore_id_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			deleteStore_id_t.setOnMouseClicked((e) -> {
...
deleteStore_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		deleteStore_Store_select_Input.setOnMouseClicked((e) -> {
...
deleteStore_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button createProductCatalog_ProductCatalog_input_State=new Button();
			createProductCatalog_ProductCatalog_input_State.setText("LoadFromState");
			createProductCatalog_content.add(createProductCatalog_ProductCatalog_input_State);
			 createProductCatalog_ProductCatalog_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createProductCatalog_ProductCatalog_input_State,2,0);
			
			Button createProductCatalog_ProductCatalog_input_reset_t=new Button();
			createProductCatalog_ProductCatalog_input_reset_t.setText("InputReset");
			createProductCatalog_content.add(createProductCatalog_ProductCatalog_input_reset_t);
			 createProductCatalog_ProductCatalog_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createProductCatalog_ProductCatalog_input_reset_t,2,1); 
			
			Button createProductCatalog_ProductCatalog_select_Input=new Button();
									createProductCatalog_ProductCatalog_select_Input.setText("SelectInput");
									createProductCatalog_content.add(createProductCatalog_ProductCatalog_select_Input);
									 createProductCatalog_ProductCatalog_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(createProductCatalog_ProductCatalog_select_Input,2,2);
			

		createProductCatalog_ProductCatalog_input_State.setOnMouseClicked((e) -> {
			List<ProductCatalog> rs = EntityManager.getAllInstancesOf("ProductCatalog") ;
			int index=(int)(Math.random() * rs.size());

				createProductCatalog_id_t.setText(String.valueOf(rs.get(index).getId()));
					

				createProductCatalog_name_t.setText(String.valueOf(rs.get(index).getName()));
			...
			//reset input button click
	 					createProductCatalog_ProductCatalog_input_reset_t.setOnMouseClicked((e) -> {
				createProductCatalog_id_t.setText("");
				createProductCatalog_name_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			createProductCatalog_id_t.setOnMouseClicked((e) -> {

			TableView obs = allObjectTables.get("ProductCatalog");
...
createProductCatalog_id_t.setText(String.valueOf(rs.get(objectindex).getId()));

		 				 			 			
createProductCatalog_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
		...
		createProductCatalog_ProductCatalog_select_Input.setOnMouseClicked((e) -> {
...
createProductCatalog_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
			...
			Button queryProductCatalog_ProductCatalog_input_State=new Button();
			queryProductCatalog_ProductCatalog_input_State.setText("LoadFromState");
			queryProductCatalog_content.add(queryProductCatalog_ProductCatalog_input_State);
			 queryProductCatalog_ProductCatalog_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(queryProductCatalog_ProductCatalog_input_State,2,0);
			
			Button queryProductCatalog_ProductCatalog_input_reset_t=new Button();
			queryProductCatalog_ProductCatalog_input_reset_t.setText("InputReset");
			queryProductCatalog_content.add(queryProductCatalog_ProductCatalog_input_reset_t);
			 queryProductCatalog_ProductCatalog_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(queryProductCatalog_ProductCatalog_input_reset_t,2,1); 
			
			Button queryProductCatalog_ProductCatalog_select_Input=new Button();
									queryProductCatalog_ProductCatalog_select_Input.setText("SelectInput");
									queryProductCatalog_content.add(queryProductCatalog_ProductCatalog_select_Input);
									 queryProductCatalog_ProductCatalog_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(queryProductCatalog_ProductCatalog_select_Input,2,2);
			

		queryProductCatalog_ProductCatalog_input_State.setOnMouseClicked((e) -> {
			List<ProductCatalog> rs = EntityManager.getAllInstancesOf("ProductCatalog") ;
			int index=(int)(Math.random() * rs.size());

				queryProductCatalog_id_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					queryProductCatalog_ProductCatalog_input_reset_t.setOnMouseClicked((e) -> {
				queryProductCatalog_id_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			queryProductCatalog_id_t.setOnMouseClicked((e) -> {
...
queryProductCatalog_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		queryProductCatalog_ProductCatalog_select_Input.setOnMouseClicked((e) -> {
...
queryProductCatalog_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button modifyProductCatalog_ProductCatalog_input_State=new Button();
			modifyProductCatalog_ProductCatalog_input_State.setText("LoadFromState");
			modifyProductCatalog_content.add(modifyProductCatalog_ProductCatalog_input_State);
			 modifyProductCatalog_ProductCatalog_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifyProductCatalog_ProductCatalog_input_State,2,0);
			
			Button modifyProductCatalog_ProductCatalog_input_reset_t=new Button();
			modifyProductCatalog_ProductCatalog_input_reset_t.setText("InputReset");
			modifyProductCatalog_content.add(modifyProductCatalog_ProductCatalog_input_reset_t);
			 modifyProductCatalog_ProductCatalog_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifyProductCatalog_ProductCatalog_input_reset_t,2,1); 
			
			Button modifyProductCatalog_ProductCatalog_select_Input=new Button();
									modifyProductCatalog_ProductCatalog_select_Input.setText("SelectInput");
									modifyProductCatalog_content.add(modifyProductCatalog_ProductCatalog_select_Input);
									 modifyProductCatalog_ProductCatalog_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(modifyProductCatalog_ProductCatalog_select_Input,2,2);
			

		modifyProductCatalog_ProductCatalog_input_State.setOnMouseClicked((e) -> {
			List<ProductCatalog> rs = EntityManager.getAllInstancesOf("ProductCatalog") ;
			int index=(int)(Math.random() * rs.size());

				modifyProductCatalog_id_t.setText(String.valueOf(rs.get(index).getId()));
					

				modifyProductCatalog_name_t.setText(String.valueOf(rs.get(index).getName()));
			...
			//reset input button click
	 					modifyProductCatalog_ProductCatalog_input_reset_t.setOnMouseClicked((e) -> {
				modifyProductCatalog_id_t.setText("");
				modifyProductCatalog_name_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			modifyProductCatalog_id_t.setOnMouseClicked((e) -> {
...
modifyProductCatalog_id_t.setText(String.valueOf(rs.get(objectindex).getId()));

		 				 			 			
modifyProductCatalog_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
		...
		modifyProductCatalog_ProductCatalog_select_Input.setOnMouseClicked((e) -> {
...
modifyProductCatalog_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
			...
			Button deleteProductCatalog_ProductCatalog_input_State=new Button();
			deleteProductCatalog_ProductCatalog_input_State.setText("LoadFromState");
			deleteProductCatalog_content.add(deleteProductCatalog_ProductCatalog_input_State);
			 deleteProductCatalog_ProductCatalog_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteProductCatalog_ProductCatalog_input_State,2,0);
			
			Button deleteProductCatalog_ProductCatalog_input_reset_t=new Button();
			deleteProductCatalog_ProductCatalog_input_reset_t.setText("InputReset");
			deleteProductCatalog_content.add(deleteProductCatalog_ProductCatalog_input_reset_t);
			 deleteProductCatalog_ProductCatalog_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteProductCatalog_ProductCatalog_input_reset_t,2,1); 
			
			Button deleteProductCatalog_ProductCatalog_select_Input=new Button();
									deleteProductCatalog_ProductCatalog_select_Input.setText("SelectInput");
									deleteProductCatalog_content.add(deleteProductCatalog_ProductCatalog_select_Input);
									 deleteProductCatalog_ProductCatalog_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(deleteProductCatalog_ProductCatalog_select_Input,2,2);
			

		deleteProductCatalog_ProductCatalog_input_State.setOnMouseClicked((e) -> {
			List<ProductCatalog> rs = EntityManager.getAllInstancesOf("ProductCatalog") ;
			int index=(int)(Math.random() * rs.size());

				deleteProductCatalog_id_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					deleteProductCatalog_ProductCatalog_input_reset_t.setOnMouseClicked((e) -> {
				deleteProductCatalog_id_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			deleteProductCatalog_id_t.setOnMouseClicked((e) -> {
...
deleteProductCatalog_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		deleteProductCatalog_ProductCatalog_select_Input.setOnMouseClicked((e) -> {
...
deleteProductCatalog_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button createCashDesk_CashDesk_input_State=new Button();
			createCashDesk_CashDesk_input_State.setText("LoadFromState");
			createCashDesk_content.add(createCashDesk_CashDesk_input_State);
			 createCashDesk_CashDesk_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createCashDesk_CashDesk_input_State,2,0);
			
			Button createCashDesk_CashDesk_input_reset_t=new Button();
			createCashDesk_CashDesk_input_reset_t.setText("InputReset");
			createCashDesk_content.add(createCashDesk_CashDesk_input_reset_t);
			 createCashDesk_CashDesk_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createCashDesk_CashDesk_input_reset_t,2,1); 
			
			Button createCashDesk_CashDesk_select_Input=new Button();
									createCashDesk_CashDesk_select_Input.setText("SelectInput");
									createCashDesk_content.add(createCashDesk_CashDesk_select_Input);
									 createCashDesk_CashDesk_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(createCashDesk_CashDesk_select_Input,2,2);
			

		createCashDesk_CashDesk_input_State.setOnMouseClicked((e) -> {
			List<CashDesk> rs = EntityManager.getAllInstancesOf("CashDesk") ;
			int index=(int)(Math.random() * rs.size());

				createCashDesk_id_t.setText(String.valueOf(rs.get(index).getId()));
					

				createCashDesk_name_t.setText(String.valueOf(rs.get(index).getName()));
					

				createCashDesk_isopened_t.setText(String.valueOf(rs.get(index).getIsOpened()));
			...
			//reset input button click
	 					createCashDesk_CashDesk_input_reset_t.setOnMouseClicked((e) -> {
				createCashDesk_id_t.setText("");
				createCashDesk_name_t.setText("");
				createCashDesk_isopened_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			createCashDesk_id_t.setOnMouseClicked((e) -> {
...
createCashDesk_id_t.setText(String.valueOf(rs.get(objectindex).getId()));

		 				 			 			
createCashDesk_name_t.setText(String.valueOf(rs.get(objectindex).getName()));

		 				 			 			
createCashDesk_isopened_t.setText(String.valueOf(rs.get(objectindex).getIsOpened()));
		...
		createCashDesk_CashDesk_select_Input.setOnMouseClicked((e) -> {
...
createCashDesk_isopened_t.setText(String.valueOf(rs.get(objectindex).getIsOpened()));
			...
			Button queryCashDesk_CashDesk_input_State=new Button();
			queryCashDesk_CashDesk_input_State.setText("LoadFromState");
			queryCashDesk_content.add(queryCashDesk_CashDesk_input_State);
			 queryCashDesk_CashDesk_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(queryCashDesk_CashDesk_input_State,2,0);
			
			Button queryCashDesk_CashDesk_input_reset_t=new Button();
			queryCashDesk_CashDesk_input_reset_t.setText("InputReset");
			queryCashDesk_content.add(queryCashDesk_CashDesk_input_reset_t);
			 queryCashDesk_CashDesk_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(queryCashDesk_CashDesk_input_reset_t,2,1); 
			
			Button queryCashDesk_CashDesk_select_Input=new Button();
									queryCashDesk_CashDesk_select_Input.setText("SelectInput");
									queryCashDesk_content.add(queryCashDesk_CashDesk_select_Input);
									 queryCashDesk_CashDesk_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(queryCashDesk_CashDesk_select_Input,2,2);
			

		queryCashDesk_CashDesk_input_State.setOnMouseClicked((e) -> {
			List<CashDesk> rs = EntityManager.getAllInstancesOf("CashDesk") ;
			int index=(int)(Math.random() * rs.size());

				queryCashDesk_id_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					queryCashDesk_CashDesk_input_reset_t.setOnMouseClicked((e) -> {
				queryCashDesk_id_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			queryCashDesk_id_t.setOnMouseClicked((e) -> {
...
queryCashDesk_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		queryCashDesk_CashDesk_select_Input.setOnMouseClicked((e) -> {
...
queryCashDesk_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button modifyCashDesk_CashDesk_input_State=new Button();
			modifyCashDesk_CashDesk_input_State.setText("LoadFromState");
			modifyCashDesk_content.add(modifyCashDesk_CashDesk_input_State);
			 modifyCashDesk_CashDesk_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifyCashDesk_CashDesk_input_State,2,0);
			
			Button modifyCashDesk_CashDesk_input_reset_t=new Button();
			modifyCashDesk_CashDesk_input_reset_t.setText("InputReset");
			modifyCashDesk_content.add(modifyCashDesk_CashDesk_input_reset_t);
			 modifyCashDesk_CashDesk_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifyCashDesk_CashDesk_input_reset_t,2,1); 
			
			Button modifyCashDesk_CashDesk_select_Input=new Button();
									modifyCashDesk_CashDesk_select_Input.setText("SelectInput");
									modifyCashDesk_content.add(modifyCashDesk_CashDesk_select_Input);
									 modifyCashDesk_CashDesk_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(modifyCashDesk_CashDesk_select_Input,2,2);
			

		modifyCashDesk_CashDesk_input_State.setOnMouseClicked((e) -> {
			List<CashDesk> rs = EntityManager.getAllInstancesOf("CashDesk") ;
			int index=(int)(Math.random() * rs.size());

				modifyCashDesk_id_t.setText(String.valueOf(rs.get(index).getId()));
					

				modifyCashDesk_name_t.setText(String.valueOf(rs.get(index).getName()));
					

				modifyCashDesk_isopened_t.setText(String.valueOf(rs.get(index).getIsOpened()));
			...
			//reset input button click
	 					modifyCashDesk_CashDesk_input_reset_t.setOnMouseClicked((e) -> {
				modifyCashDesk_id_t.setText("");
				modifyCashDesk_name_t.setText("");
				modifyCashDesk_isopened_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			modifyCashDesk_id_t.setOnMouseClicked((e) -> {
...
modifyCashDesk_id_t.setText(String.valueOf(rs.get(objectindex).getId()));

		 				 			 			
modifyCashDesk_name_t.setText(String.valueOf(rs.get(objectindex).getName()));

		 				 			 			
modifyCashDesk_isopened_t.setText(String.valueOf(rs.get(objectindex).getIsOpened()));
		...
		modifyCashDesk_CashDesk_select_Input.setOnMouseClicked((e) -> {
...
modifyCashDesk_isopened_t.setText(String.valueOf(rs.get(objectindex).getIsOpened()));
			...
			Button deleteCashDesk_CashDesk_input_State=new Button();
			deleteCashDesk_CashDesk_input_State.setText("LoadFromState");
			deleteCashDesk_content.add(deleteCashDesk_CashDesk_input_State);
			 deleteCashDesk_CashDesk_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteCashDesk_CashDesk_input_State,2,0);
			
			Button deleteCashDesk_CashDesk_input_reset_t=new Button();
			deleteCashDesk_CashDesk_input_reset_t.setText("InputReset");
			deleteCashDesk_content.add(deleteCashDesk_CashDesk_input_reset_t);
			 deleteCashDesk_CashDesk_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteCashDesk_CashDesk_input_reset_t,2,1); 
			
			Button deleteCashDesk_CashDesk_select_Input=new Button();
									deleteCashDesk_CashDesk_select_Input.setText("SelectInput");
									deleteCashDesk_content.add(deleteCashDesk_CashDesk_select_Input);
									 deleteCashDesk_CashDesk_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(deleteCashDesk_CashDesk_select_Input,2,2);
			

		deleteCashDesk_CashDesk_input_State.setOnMouseClicked((e) -> {
			List<CashDesk> rs = EntityManager.getAllInstancesOf("CashDesk") ;
			int index=(int)(Math.random() * rs.size());

				deleteCashDesk_id_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					deleteCashDesk_CashDesk_input_reset_t.setOnMouseClicked((e) -> {
				deleteCashDesk_id_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			deleteCashDesk_id_t.setOnMouseClicked((e) -> {
...
deleteCashDesk_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		deleteCashDesk_CashDesk_select_Input.setOnMouseClicked((e) -> {
...
deleteCashDesk_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button createCashier_Cashier_input_State=new Button();
			createCashier_Cashier_input_State.setText("LoadFromState");
			createCashier_content.add(createCashier_Cashier_input_State);
			 createCashier_Cashier_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createCashier_Cashier_input_State,2,0);
			
			Button createCashier_Cashier_input_reset_t=new Button();
			createCashier_Cashier_input_reset_t.setText("InputReset");
			createCashier_content.add(createCashier_Cashier_input_reset_t);
			 createCashier_Cashier_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createCashier_Cashier_input_reset_t,2,1); 
			
			Button createCashier_Cashier_select_Input=new Button();
									createCashier_Cashier_select_Input.setText("SelectInput");
									createCashier_content.add(createCashier_Cashier_select_Input);
									 createCashier_Cashier_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(createCashier_Cashier_select_Input,2,2);
			

		createCashier_Cashier_input_State.setOnMouseClicked((e) -> {
			List<Cashier> rs = EntityManager.getAllInstancesOf("Cashier") ;
			int index=(int)(Math.random() * rs.size());

				createCashier_id_t.setText(String.valueOf(rs.get(index).getId()));
					

				createCashier_name_t.setText(String.valueOf(rs.get(index).getName()));
			...
			//reset input button click
	 					createCashier_Cashier_input_reset_t.setOnMouseClicked((e) -> {
				createCashier_id_t.setText("");
				createCashier_name_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			createCashier_id_t.setOnMouseClicked((e) -> {

			TableView obs = allObjectTables.get("Cashier");
...
createCashier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));

		 				 			 			
createCashier_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
		...
		createCashier_Cashier_select_Input.setOnMouseClicked((e) -> {
...
createCashier_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
			...
			Button queryCashier_Cashier_input_State=new Button();
			queryCashier_Cashier_input_State.setText("LoadFromState");
			queryCashier_content.add(queryCashier_Cashier_input_State);
			 queryCashier_Cashier_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(queryCashier_Cashier_input_State,2,0);
			
			Button queryCashier_Cashier_input_reset_t=new Button();
			queryCashier_Cashier_input_reset_t.setText("InputReset");
			queryCashier_content.add(queryCashier_Cashier_input_reset_t);
			 queryCashier_Cashier_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(queryCashier_Cashier_input_reset_t,2,1); 
			
			Button queryCashier_Cashier_select_Input=new Button();
									queryCashier_Cashier_select_Input.setText("SelectInput");
									queryCashier_content.add(queryCashier_Cashier_select_Input);
									 queryCashier_Cashier_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(queryCashier_Cashier_select_Input,2,2);
			

		queryCashier_Cashier_input_State.setOnMouseClicked((e) -> {
			List<Cashier> rs = EntityManager.getAllInstancesOf("Cashier") ;
			int index=(int)(Math.random() * rs.size());

				queryCashier_id_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					queryCashier_Cashier_input_reset_t.setOnMouseClicked((e) -> {
				queryCashier_id_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			queryCashier_id_t.setOnMouseClicked((e) -> {
...
queryCashier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		queryCashier_Cashier_select_Input.setOnMouseClicked((e) -> {
...
queryCashier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button modifyCashier_Cashier_input_State=new Button();
			modifyCashier_Cashier_input_State.setText("LoadFromState");
			modifyCashier_content.add(modifyCashier_Cashier_input_State);
			 modifyCashier_Cashier_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifyCashier_Cashier_input_State,2,0);
			
			Button modifyCashier_Cashier_input_reset_t=new Button();
			modifyCashier_Cashier_input_reset_t.setText("InputReset");
			modifyCashier_content.add(modifyCashier_Cashier_input_reset_t);
			 modifyCashier_Cashier_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifyCashier_Cashier_input_reset_t,2,1); 
			
			Button modifyCashier_Cashier_select_Input=new Button();
									modifyCashier_Cashier_select_Input.setText("SelectInput");
									modifyCashier_content.add(modifyCashier_Cashier_select_Input);
									 modifyCashier_Cashier_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(modifyCashier_Cashier_select_Input,2,2);
			

		modifyCashier_Cashier_input_State.setOnMouseClicked((e) -> {
			List<Cashier> rs = EntityManager.getAllInstancesOf("Cashier") ;
			int index=(int)(Math.random() * rs.size());

				modifyCashier_id_t.setText(String.valueOf(rs.get(index).getId()));
					

				modifyCashier_name_t.setText(String.valueOf(rs.get(index).getName()));
			...
			//reset input button click
	 					modifyCashier_Cashier_input_reset_t.setOnMouseClicked((e) -> {
				modifyCashier_id_t.setText("");
				modifyCashier_name_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			modifyCashier_id_t.setOnMouseClicked((e) -> {
...
modifyCashier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));

		 				 			 			
modifyCashier_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
		...
		modifyCashier_Cashier_select_Input.setOnMouseClicked((e) -> {
...
modifyCashier_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
			...
			Button deleteCashier_Cashier_input_State=new Button();
			deleteCashier_Cashier_input_State.setText("LoadFromState");
			deleteCashier_content.add(deleteCashier_Cashier_input_State);
			 deleteCashier_Cashier_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteCashier_Cashier_input_State,2,0);
			
			Button deleteCashier_Cashier_input_reset_t=new Button();
			deleteCashier_Cashier_input_reset_t.setText("InputReset");
			deleteCashier_content.add(deleteCashier_Cashier_input_reset_t);
			 deleteCashier_Cashier_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteCashier_Cashier_input_reset_t,2,1); 
			
			Button deleteCashier_Cashier_select_Input=new Button();
									deleteCashier_Cashier_select_Input.setText("SelectInput");
									deleteCashier_content.add(deleteCashier_Cashier_select_Input);
									 deleteCashier_Cashier_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(deleteCashier_Cashier_select_Input,2,2);
			

		deleteCashier_Cashier_input_State.setOnMouseClicked((e) -> {
			List<Cashier> rs = EntityManager.getAllInstancesOf("Cashier") ;
			int index=(int)(Math.random() * rs.size());

				deleteCashier_id_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					deleteCashier_Cashier_input_reset_t.setOnMouseClicked((e) -> {
				deleteCashier_id_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			deleteCashier_id_t.setOnMouseClicked((e) -> {
...
deleteCashier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		deleteCashier_Cashier_select_Input.setOnMouseClicked((e) -> {
...
deleteCashier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button createItem_Item_input_State=new Button();
			createItem_Item_input_State.setText("LoadFromState");
			createItem_content.add(createItem_Item_input_State);
			 createItem_Item_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createItem_Item_input_State,2,0);
			
			Button createItem_Item_input_reset_t=new Button();
			createItem_Item_input_reset_t.setText("InputReset");
			createItem_content.add(createItem_Item_input_reset_t);
			 createItem_Item_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createItem_Item_input_reset_t,2,1); 
			
			Button createItem_Item_select_Input=new Button();
									createItem_Item_select_Input.setText("SelectInput");
									createItem_content.add(createItem_Item_select_Input);
									 createItem_Item_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(createItem_Item_select_Input,2,2);
			

		createItem_Item_input_State.setOnMouseClicked((e) -> {
			List<Item> rs = EntityManager.getAllInstancesOf("Item") ;
			int index=(int)(Math.random() * rs.size());

				createItem_barcode_t.setText(String.valueOf(rs.get(index).getBarcode()));
					

				createItem_name_t.setText(String.valueOf(rs.get(index).getName()));
					

				createItem_price_t.setText(String.valueOf(rs.get(index).getPrice()));
					

				createItem_stocknumber_t.setText(String.valueOf(rs.get(index).getStockNumber()));
					

				createItem_orderprice_t.setText(String.valueOf(rs.get(index).getOrderPrice()));
			...
			//reset input button click
	 					createItem_Item_input_reset_t.setOnMouseClicked((e) -> {
				createItem_barcode_t.setText("");
				createItem_name_t.setText("");
				createItem_price_t.setText("");
				createItem_stocknumber_t.setText("");
				createItem_orderprice_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			createItem_barcode_t.setOnMouseClicked((e) -> {
...
createItem_barcode_t.setText(String.valueOf(rs.get(objectindex).getBarcode()));

		 				 			 			
createItem_name_t.setText(String.valueOf(rs.get(objectindex).getName()));

		 				 			 			
createItem_price_t.setText(String.valueOf(rs.get(objectindex).getPrice()));

		 				 			 			
createItem_stocknumber_t.setText(String.valueOf(rs.get(objectindex).getStockNumber()));

		 				 			 			
createItem_orderprice_t.setText(String.valueOf(rs.get(objectindex).getOrderPrice()));
		...
		createItem_Item_select_Input.setOnMouseClicked((e) -> {
...
createItem_orderprice_t.setText(String.valueOf(rs.get(objectindex).getOrderPrice()));
			...
			Button queryItem_Item_input_State=new Button();
			queryItem_Item_input_State.setText("LoadFromState");
			queryItem_content.add(queryItem_Item_input_State);
			 queryItem_Item_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(queryItem_Item_input_State,2,0);
			
			Button queryItem_Item_input_reset_t=new Button();
			queryItem_Item_input_reset_t.setText("InputReset");
			queryItem_content.add(queryItem_Item_input_reset_t);
			 queryItem_Item_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(queryItem_Item_input_reset_t,2,1); 
			
			Button queryItem_Item_select_Input=new Button();
									queryItem_Item_select_Input.setText("SelectInput");
									queryItem_content.add(queryItem_Item_select_Input);
									 queryItem_Item_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(queryItem_Item_select_Input,2,2);
			

		queryItem_Item_input_State.setOnMouseClicked((e) -> {
			List<Item> rs = EntityManager.getAllInstancesOf("Item") ;
			int index=(int)(Math.random() * rs.size());

				queryItem_barcode_t.setText(String.valueOf(rs.get(index).getBarcode()));
			...
			//reset input button click
	 					queryItem_Item_input_reset_t.setOnMouseClicked((e) -> {
				queryItem_barcode_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			queryItem_barcode_t.setOnMouseClicked((e) -> {
...
queryItem_barcode_t.setText(String.valueOf(rs.get(objectindex).getBarcode()));
		...
		queryItem_Item_select_Input.setOnMouseClicked((e) -> {
...
queryItem_barcode_t.setText(String.valueOf(rs.get(objectindex).getBarcode()));
			...
			Button modifyItem_Item_input_State=new Button();
			modifyItem_Item_input_State.setText("LoadFromState");
			modifyItem_content.add(modifyItem_Item_input_State);
			 modifyItem_Item_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifyItem_Item_input_State,2,0);
			
			Button modifyItem_Item_input_reset_t=new Button();
			modifyItem_Item_input_reset_t.setText("InputReset");
			modifyItem_content.add(modifyItem_Item_input_reset_t);
			 modifyItem_Item_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifyItem_Item_input_reset_t,2,1); 
			
			Button modifyItem_Item_select_Input=new Button();
									modifyItem_Item_select_Input.setText("SelectInput");
									modifyItem_content.add(modifyItem_Item_select_Input);
									 modifyItem_Item_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(modifyItem_Item_select_Input,2,2);
			

		modifyItem_Item_input_State.setOnMouseClicked((e) -> {
			List<Item> rs = EntityManager.getAllInstancesOf("Item") ;
			int index=(int)(Math.random() * rs.size());

				modifyItem_barcode_t.setText(String.valueOf(rs.get(index).getBarcode()));
					

				modifyItem_name_t.setText(String.valueOf(rs.get(index).getName()));
					

				modifyItem_price_t.setText(String.valueOf(rs.get(index).getPrice()));
					

				modifyItem_stocknumber_t.setText(String.valueOf(rs.get(index).getStockNumber()));
					

				modifyItem_orderprice_t.setText(String.valueOf(rs.get(index).getOrderPrice()));
			...
			//reset input button click
	 					modifyItem_Item_input_reset_t.setOnMouseClicked((e) -> {
				modifyItem_barcode_t.setText("");
				modifyItem_name_t.setText("");
				modifyItem_price_t.setText("");
				modifyItem_stocknumber_t.setText("");
				modifyItem_orderprice_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			modifyItem_barcode_t.setOnMouseClicked((e) -> {
...
modifyItem_barcode_t.setText(String.valueOf(rs.get(objectindex).getBarcode()));

		 				 			 			
modifyItem_name_t.setText(String.valueOf(rs.get(objectindex).getName()));

		 				 			 			
modifyItem_price_t.setText(String.valueOf(rs.get(objectindex).getPrice()));

		 				 			 			
modifyItem_stocknumber_t.setText(String.valueOf(rs.get(objectindex).getStockNumber()));

		 				 			 			
modifyItem_orderprice_t.setText(String.valueOf(rs.get(objectindex).getOrderPrice()));
		...
		modifyItem_Item_select_Input.setOnMouseClicked((e) -> {
...
modifyItem_orderprice_t.setText(String.valueOf(rs.get(objectindex).getOrderPrice()));
			...
			Button deleteItem_Item_input_State=new Button();
			deleteItem_Item_input_State.setText("LoadFromState");
			deleteItem_content.add(deleteItem_Item_input_State);
			 deleteItem_Item_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteItem_Item_input_State,2,0);
			
			Button deleteItem_Item_input_reset_t=new Button();
			deleteItem_Item_input_reset_t.setText("InputReset");
			deleteItem_content.add(deleteItem_Item_input_reset_t);
			 deleteItem_Item_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteItem_Item_input_reset_t,2,1); 
			
			Button deleteItem_Item_select_Input=new Button();
									deleteItem_Item_select_Input.setText("SelectInput");
									deleteItem_content.add(deleteItem_Item_select_Input);
									 deleteItem_Item_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(deleteItem_Item_select_Input,2,2);
			

		deleteItem_Item_input_State.setOnMouseClicked((e) -> {
			List<Item> rs = EntityManager.getAllInstancesOf("Item") ;
			int index=(int)(Math.random() * rs.size());

				deleteItem_barcode_t.setText(String.valueOf(rs.get(index).getBarcode()));
			...
			//reset input button click
	 					deleteItem_Item_input_reset_t.setOnMouseClicked((e) -> {
				deleteItem_barcode_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			deleteItem_barcode_t.setOnMouseClicked((e) -> {
...
deleteItem_barcode_t.setText(String.valueOf(rs.get(objectindex).getBarcode()));
		...
		deleteItem_Item_select_Input.setOnMouseClicked((e) -> {
...
deleteItem_barcode_t.setText(String.valueOf(rs.get(objectindex).getBarcode()));
			...
			Button createSupplier_Supplier_input_State=new Button();
			createSupplier_Supplier_input_State.setText("LoadFromState");
			createSupplier_content.add(createSupplier_Supplier_input_State);
			 createSupplier_Supplier_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createSupplier_Supplier_input_State,2,0);
			
			Button createSupplier_Supplier_input_reset_t=new Button();
			createSupplier_Supplier_input_reset_t.setText("InputReset");
			createSupplier_content.add(createSupplier_Supplier_input_reset_t);
			 createSupplier_Supplier_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(createSupplier_Supplier_input_reset_t,2,1); 
			
			Button createSupplier_Supplier_select_Input=new Button();
									createSupplier_Supplier_select_Input.setText("SelectInput");
									createSupplier_content.add(createSupplier_Supplier_select_Input);
									 createSupplier_Supplier_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(createSupplier_Supplier_select_Input,2,2);
			

		createSupplier_Supplier_input_State.setOnMouseClicked((e) -> {
			List<Supplier> rs = EntityManager.getAllInstancesOf("Supplier") ;
			int index=(int)(Math.random() * rs.size());

				createSupplier_id_t.setText(String.valueOf(rs.get(index).getId()));
					

				createSupplier_name_t.setText(String.valueOf(rs.get(index).getName()));
			...
			//reset input button click
	 					createSupplier_Supplier_input_reset_t.setOnMouseClicked((e) -> {
				createSupplier_id_t.setText("");
				createSupplier_name_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			createSupplier_id_t.setOnMouseClicked((e) -> {
...
createSupplier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));

		 				 			 			
createSupplier_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
		...
		createSupplier_Supplier_select_Input.setOnMouseClicked((e) -> {
...
createSupplier_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
			...
			Button querySupplier_Supplier_input_State=new Button();
			querySupplier_Supplier_input_State.setText("LoadFromState");
			querySupplier_content.add(querySupplier_Supplier_input_State);
			 querySupplier_Supplier_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(querySupplier_Supplier_input_State,2,0);
			
			Button querySupplier_Supplier_input_reset_t=new Button();
			querySupplier_Supplier_input_reset_t.setText("InputReset");
			querySupplier_content.add(querySupplier_Supplier_input_reset_t);
			 querySupplier_Supplier_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(querySupplier_Supplier_input_reset_t,2,1); 
			
			Button querySupplier_Supplier_select_Input=new Button();
									querySupplier_Supplier_select_Input.setText("SelectInput");
									querySupplier_content.add(querySupplier_Supplier_select_Input);
									 querySupplier_Supplier_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(querySupplier_Supplier_select_Input,2,2);
			

		querySupplier_Supplier_input_State.setOnMouseClicked((e) -> {
			List<Supplier> rs = EntityManager.getAllInstancesOf("Supplier") ;
			int index=(int)(Math.random() * rs.size());

				querySupplier_id_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					querySupplier_Supplier_input_reset_t.setOnMouseClicked((e) -> {
				querySupplier_id_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			querySupplier_id_t.setOnMouseClicked((e) -> {
...
querySupplier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		querySupplier_Supplier_select_Input.setOnMouseClicked((e) -> {
...
querySupplier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
			...
			Button modifySupplier_Supplier_input_State=new Button();
			modifySupplier_Supplier_input_State.setText("LoadFromState");
			modifySupplier_content.add(modifySupplier_Supplier_input_State);
			 modifySupplier_Supplier_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifySupplier_Supplier_input_State,2,0);
			
			Button modifySupplier_Supplier_input_reset_t=new Button();
			modifySupplier_Supplier_input_reset_t.setText("InputReset");
			modifySupplier_content.add(modifySupplier_Supplier_input_reset_t);
			 modifySupplier_Supplier_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(modifySupplier_Supplier_input_reset_t,2,1); 
			
			Button modifySupplier_Supplier_select_Input=new Button();
									modifySupplier_Supplier_select_Input.setText("SelectInput");
									modifySupplier_content.add(modifySupplier_Supplier_select_Input);
									 modifySupplier_Supplier_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(modifySupplier_Supplier_select_Input,2,2);
			

		modifySupplier_Supplier_input_State.setOnMouseClicked((e) -> {
			List<Supplier> rs = EntityManager.getAllInstancesOf("Supplier") ;
			int index=(int)(Math.random() * rs.size());

				modifySupplier_id_t.setText(String.valueOf(rs.get(index).getId()));
					

				modifySupplier_name_t.setText(String.valueOf(rs.get(index).getName()));
			...
			//reset input button click
	 					modifySupplier_Supplier_input_reset_t.setOnMouseClicked((e) -> {
				modifySupplier_id_t.setText("");
				modifySupplier_name_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			modifySupplier_id_t.setOnMouseClicked((e) -> {
...
modifySupplier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));

		 				 			 			
modifySupplier_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
		...
		modifySupplier_Supplier_select_Input.setOnMouseClicked((e) -> {
...
modifySupplier_name_t.setText(String.valueOf(rs.get(objectindex).getName()));
			...
			Button deleteSupplier_Supplier_input_State=new Button();
			deleteSupplier_Supplier_input_State.setText("LoadFromState");
			deleteSupplier_content.add(deleteSupplier_Supplier_input_State);
			 deleteSupplier_Supplier_input_State.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteSupplier_Supplier_input_State,2,0);
			
			Button deleteSupplier_Supplier_input_reset_t=new Button();
			deleteSupplier_Supplier_input_reset_t.setText("InputReset");
			deleteSupplier_content.add(deleteSupplier_Supplier_input_reset_t);
			 deleteSupplier_Supplier_input_reset_t.setMinWidth(Region.USE_PREF_SIZE);
			GridPane.setConstraints(deleteSupplier_Supplier_input_reset_t,2,1); 
			
			Button deleteSupplier_Supplier_select_Input=new Button();
									deleteSupplier_Supplier_select_Input.setText("SelectInput");
									deleteSupplier_content.add(deleteSupplier_Supplier_select_Input);
									 deleteSupplier_Supplier_select_Input.setMinWidth(Region.USE_PREF_SIZE);
									GridPane.setConstraints(deleteSupplier_Supplier_select_Input,2,2);
			

		deleteSupplier_Supplier_input_State.setOnMouseClicked((e) -> {
			List<Supplier> rs = EntityManager.getAllInstancesOf("Supplier") ;
			int index=(int)(Math.random() * rs.size());

				deleteSupplier_id_t.setText(String.valueOf(rs.get(index).getId()));
			...
			//reset input button click
	 					deleteSupplier_Supplier_input_reset_t.setOnMouseClicked((e) -> {
				deleteSupplier_id_t.setText("");
			...
			// refresh GUI after load data
 			refreshAll();
	 			...
	 			deleteSupplier_id_t.setOnMouseClicked((e) -> {
...
deleteSupplier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
		...
		deleteSupplier_Supplier_select_Input.setOnMouseClicked((e) -> {
...
deleteSupplier_id_t.setText(String.valueOf(rs.get(objectindex).getId()));
	...
	public void actorTreeViewBinding() {
		...
		TreeItem<String> treeRootcashier = new TreeItem<String>("Root node");
			...
			TreeItem<String> subTreeRoot_openCashDesk = new TreeItem<String>("openCashDesk");
			subTreeRoot_openCashDesk.getChildren().addAll(Arrays.asList(
					
				 	new TreeItem<String>("openCashDesk")
				 	));
			TreeItem<String> subTreeRoot_closeCashDesk = new TreeItem<String>("closeCashDesk");
			subTreeRoot_closeCashDesk.getChildren().addAll(Arrays.asList(
		...
		TreeItem<String> treeRootstoremanager = new TreeItem<String>("Root node");
			...
			TreeItem<String> subTreeRoot_receiveOrderedProduct = new TreeItem<String>("receiveOrderedProduct");
			subTreeRoot_receiveOrderedProduct.getChildren().addAll(Arrays.asList(
					
				 	new TreeItem<String>("receiveOrderedProduct")
				 	));
			TreeItem<String> subTreeRoot_showStockReports = new TreeItem<String>("showStockReports");
			subTreeRoot_showStockReports.getChildren().addAll(Arrays.asList(
					
				 	new TreeItem<String>("showStockReports")
				 	));
			TreeItem<String> subTreeRoot_changePrice = new TreeItem<String>("changePrice");
			subTreeRoot_changePrice.getChildren().addAll(Arrays.asList(
					
				 	new TreeItem<String>("changePrice")
				 	));
			TreeItem<String> subTreeRoot_listSuppliers = new TreeItem<String>("listSuppliers");
			subTreeRoot_listSuppliers.getChildren().addAll(Arrays.asList(
					
				 	new TreeItem<String>("listSuppliers")
				 	));
			TreeItem<String> subTreeRoot_openStore = new TreeItem<String>("openStore");
			subTreeRoot_openStore.getChildren().addAll(Arrays.asList(
					
				 	new TreeItem<String>("openStore")
				 	));
			TreeItem<String> subTreeRoot_closeStore = new TreeItem<String>("closeStore");
			subTreeRoot_closeStore.getChildren().addAll(Arrays.asList(
...
public void save(ActionEvent event) {
 ...
 public void startclick(TableView tableView, String Title) 
	{	
		...
		TableColumn<Object, String> column = new TableColumn<>("Input index");
		column.setCellFactory(param -> new TableCell<Object, String>() {
			...
			protected void updateItem(String item, boolean empty) {
				...
				if (!empty) {
					...
					this.setText("input" + String.valueOf(rowIndex));
				}
			}
		});
		tableView.getColumns().add(column);		 Scene scene = new Scene(vbox, 450, 300);
	     primaryStage.setTitle("All Objects "+Title +": ");
	     primaryStage.setScene(scene);

	     primaryStage.show();
	}
String yamlPath;int objectindex;
